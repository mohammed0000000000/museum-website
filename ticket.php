...
<body>
    <header>
        <div class="container">
            <nav>
                <div href="" class="logo">
                    <img src="images/thelogo.png" alt="" srcset="">
                </div>
                <div class="togal">
    ...
    <div class="landing">
        <div class="container">
            ...
            <div class="date">
                <div class="in">
                    <label for=""><h3>Choose Your Visit Date :</h3></label>
            ...
            <table class="table">
                ...
                <tbody>
                   <tr>
                            ...
                            <td class="numb"><input id="frist" type="number" name="" id="" value="0"></td>
                            <td class="price">30 EGP</td>
                        </tr>
                        <tr>
                            <td class="type">Student - Arab</td>
                            <td class="numb"><input id="second" type="number" name="" id="" value="0"></td>
                            <td class="price">15 EGP</td>
                        </tr>
                        <tr>
                            <td class="type">Tourist</td>
                            <td class="numb"><input id="third" type="number" name="" id="" value="0"></td>
                        ...
                        <tr>
                            ...
                            <td class="last"> <button>Press</button> </td>
                        </tr>
